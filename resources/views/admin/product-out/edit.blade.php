                ...
                <div class="card">
                    ...
                    <form action="{{ route('admin.product-out.update', Crypt::encrypt($product_out->id)) }}"
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary float-right simpan">Submit</button>
                        </div>
                    </form>
                    <!-- /.card-body -->
                </div>
...
@push('script')
    ...
    <script>
        ...
        $('#stok_keluar').keyup(function(e) {
            if (e.target.value) {
                var opration = parseInt($('#stok_barang').val()) - parseInt(e.target.value);
                $('#total_stok').val(parseInt($('#stok_barang').val()) - parseInt(e.target.value));
                if (opration < 0) {
                    $('.keluarError').text('Stok Keluar kebesaran!');
