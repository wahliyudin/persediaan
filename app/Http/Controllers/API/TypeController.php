...
class TypeController extends Controller
{
    ...
    public function edit($id)
    {
        try {
            ...
            $unit = Type::find($id);
            if (!$unit) {
                throw new Exception('Data tipe tidak ditemukan!', 400);
            }
            $data = [
